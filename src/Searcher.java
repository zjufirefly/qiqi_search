...
//		remember_words += "想穿最响菜帮自己舞谁虾放公眨体物伴倒而碗煮蘑菇膀扶梯肚定指约肩澡板琴锅";
	...
	public static void init_all_words() {
		...
		all_words[7] = "格外艳呀每言语啦梅用几成娃为参加洞睡放步熊快怎饭班拿正礼物今孩让起玩往觉烧知道化砍造满舍结年直动束丽mi";
		...
		all_words[20] = "瘦暗丑闲旧海鸥滩军舰帆秧稻塘溪竿铜号领忘挖井席导革命战士解刻念望助哨敌荡顺突枪杀害英雄冲部宽虾脚捡贝";
		all_words[21] = "壳原奔密匹市楼吹祝贺希祖国由羽丰勇敢理敬度厂甲申句兄虚骄傲淡诚实赢赞招翻浇施肥饿候挑担狮整练习滚扑咬";
		all_words[22] = "懒洋吞将靠应餐丢矿糟糕粗概共汽记保管夹盆位选并宣分芽规盛丝表煮饼饮饺子猪狼初眉辨斗湖即雁归转寒姑娘蚜";
		all_words[23] = "盼治啄斑俩摘伯而且踢引兰梁程波架特砖划采薄巧稳郊列弄查速度断提修建世界创梦名灰迎阿姨追披鼓甘埋闯掰跌";
		all_words[24] = "宜层尽染叠翠爽壮谷登华图梨笼浪粱燃勤劳区尤其仙盘峰胳膊巨当脖著形状旅蒲降娃纷苍洼啪炸蹦察识刘菊残君橙";
