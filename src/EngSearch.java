...
public class EngSearch {
    ...
    public static void intiSightWord() {
        ...
        remSightWord = " her they and is my that this he she who " + //vip u4l1
                ...
                " write look want where make read not but find right help "+ //vipkid u2l89
        " the go in out can jump run sit over six seven has too many green new blue yellow white black have  do does be "; //raz 2 3 4 5
